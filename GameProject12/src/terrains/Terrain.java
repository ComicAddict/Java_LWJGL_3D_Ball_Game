...
public class Terrain {
	...
	/**
	 * Constructs a terrain with a height map
	 * 
	 * @param gridX
	 * @param gridZ
	 * @param loader
	...
	/**
	 * Gives the information of presence of height map
	 * 
	 * @return hasHeightMap
	 */
	...
	/**
	 * Returns the model of the terrain
	 * 
	 * @return
	 */
	...
	/**
	 * Gives the height of the terrain at the given location
	 * 
	 * @param worldX
	 * @param worldZ
	 * @return height
	...
	/**
	 * Gives a raw model with given information, Includes a heigth map
	 * 
	 * @param loader
	 * @param heightMap
	 * @return raw model of the terrain
	 */
	...
	/**
	 * Gives a raw model with given information
	 * 
	 * @param loader
	 * @return raw model of the terrain
	 */
	...
	/**
	 * Calculates the normal vector at the given coordinates of the image
	 * 
	 * @param x
	 * @param z
	 * @param image
	...
	/**
	 * Gives the height at the given coordinates of the image
	 * 
	 * @param x
	 * @param z
	 * @param image
